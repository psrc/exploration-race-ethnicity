...
# Variables
excel_file_path <- 'renter-cost-burden-size/data' #folder path
indicator_file <- 'renter-cost-burden-by-re-hhsize.xlsx' # Excel file name
...
process_sp_sheet <- function(sheet_name){
  ...
  df_multirace_harvard[, 5:16][df_multirace_harvard[, 5:16] >= 0] <- NA
